# scripts/gen_mains_ancient.py
import json

def get_ancient_mains():
    qs = []
    
    # 40 Complete, High-Quality Ancient Mains Questions with Model Frameworks
    items = [
        {
            "id": "mains_anc_001", "periodId": "indus-valley-civilization", "marks": 15, "wordLimit": 250, "isPyq": True,
            "yearSource": "UPSC CSE 2020 GS-1", "bookRef": "Upinder Singh, Ch. 4; NCERT Class 12 Themes Theme 1",
            "question": "To what extent can the urban planning and drainage architecture of the Indus Valley Civilisation offer practical insights for solving contemporary civic and sanitation challenges in modern Indian cities?",
            "framework": {
                ...
                "body": [
                    {"heading": "Gridiron Layout & Functional Zoning", "points": [
                        "Segregation of residential quarters from public administrative/craft zones (Citadel vs Lower Town).",
                        "Streets aligned along cardinal directions (North-South, East-West) to utilize natural wind circulation for street cleaning.",
                        "Relevance: Offers lessons for modern urban master-planning to curb unplanned urban sprawl and congested slums."
                    ]},
                    {"heading": "Underground Drainage & Waste Management", "points": [
                        "Covered masonry wastewater drains running along streets with gradient slopes to prevent water stagnation.",
                        "Inspection manholes with removable limestone covers, terracotta soak pits, and grease traps at household outlets.",
                        "Relevance: Direct contrast to contemporary open storm drains prone to clogging, vector epidemics, and catastrophic urban flooding (e.g., Chennai, Delhi, Mumbai)."
                    ]},
                    {"heading": "Decentralized Water Harvesting & Conservation", "points": [
                        "Dholavira's cascading stone-cut reservoirs and stormwater bundling systems harvesting seasonal hill runoffs from Manhar and Mansar streams.",
                        "Deep brick-lined public and private wells (over 700 in Mohenjo-daro alone).",
                        "Relevance: Provides an ancient engineering blueprint for the Jal Jeevan Mission and decentralized rainwater harvesting in climate-stressed arid zones."
                    ]},
                    {"heading": "Standardization & Building Bye-Laws", "points": [
                        "Strict adherence to the 4:2:1 brick proportion across thousands of kilometers.",
                        "House entrances opening onto secondary alleys rather than main arterial roads, minimizing noise pollution and traffic disruption.",
                        "Relevance: Highlights strict enforcement of municipal building codes, currently lacking in rapidly urbanizing Indian peri-urban corridors."
                    ]}
                ],
                "diagramMapIdea": "Schematic sketch of Dholavira's tripartite zoning (Castle, Bailey, Middle Town, Lower Town) with encircling reservoir tanks; flowchart of Harappan household soak-pit connecting to covered municipal street drain.",
                "conclusion": "Modern initiatives like the Smart Cities Mission and Swachh Bharat Abhiyan essentially strive to recreate the civic priorities and sustainable urban sanitation that Harappan municipal engineers mastered over four millennia ago."
            }
        },
        {
            "id": "mains_anc_002", "periodId": "indus-valley-civilization", "marks": 10, "wordLimit": 150, "isPyq": True,
            "yearSource": "UPSC CSE 2018 GS-1", "bookRef": "Upinder Singh, Ch. 4; R.S. Sharma, Ch. 6",
            "question": "The decline of the Harappan civilization was not an abrupt cataclysm but a gradual process of de-urbanization caused by multiple ecological and economic factors. Critically discuss.",
            "framework": {
                "intro": "Recent archaeological excavations and palaeoclimatic studies have refuted Mortimer Wheeler's 20th-century 'Aryan invasion' theory, demonstrating that the collapse of Mature Harappa (c. 1900 BCE) was a complex, multi-century process termed the 'Late Harappan / Post-Urban phase'.",
                "body": [
                    {"heading": "Ecological & Climatic Shifts", "points": [
                        "Weakening of the Indian Summer Monsoon and progressive desiccation of the Saraswati/Ghaggar-Hakra river system.",
                        "Tectonic shifts causing river avulsion and catastrophic flash flooding (evidenced by multiple silt layers at Mohenjo-daro).",
                        "Deforestation and soil exhaustion caused by centuries of baking millions of mud bricks and fuelling pottery kilns."
                    ]},
                    {"heading": "Breakdown of Long-Distance Trade", "points": [
                        "Mesopotamian cuneiform tablets abruptly cease mentions of maritime trade with 'Meluhha' after the reign of Hammurabi.",
                        "Disruption of vital raw material supplies (copper from Khetri, lapis lazuli from Badakhshan) severed the economic arteries sustaining specialized urban craft elites."
                    ]},
                    {"heading": "Ruralization & Regional Reorientation", "points": [
                        "De-urbanization did not mean extinction; populations migrated eastwards and southwards into the Ganga-Yamuna Doab (OCP culture) and Gujarat (Rangpur, Rojdi).",
                        "Loss of the Indus script, standardized weights, and baked bricks, transitioning into decentralized agrarian agro-pastoral village cultures."
                    ]}
                ],
                "diagramMapIdea": "Timeline arrow: Early Harappan (3300-2600 BCE) -> Mature Urban Harappan (2600-1900 BCE) -> Late Harappan Degenerative Phase (1900-1300 BCE) -> Rural Settlements.",
                "conclusion": "Thus, the 'fall' of Harappa is best understood as systemic urban devolution under multi-causal ecological stresses, which reshaped the demographic contours of North India rather than causing a sudden demographic void."
            }
        },
        {
            "id": "mains_anc_003", "periodId": "vedic-age", "marks": 15, "wordLimit": 250, "isPyq": False,
            "yearSource": "UPSC CSE Standard Practice", "bookRef": "R.S. Sharma, Ch. 11-12; NCERT Class 11",
            "question": "Examine the profound socio-economic and political transformations between the Early Vedic (Rigvedic) and Later Vedic societies, highlighting how the discovery and use of iron altered the historical trajectory.",
            "framework": {
                "intro": "The transition from the Early Vedic period (c. 1500-1000 BCE in the Saptasindhu) to the Later Vedic period (c. 1000-600 BCE in the Ganga-Yamuna Doab) marks India's transition from an egalitarian pastoral tribal society to a territorial, stratified, and agrarian polity.",
                "body": [
                    {"heading": "Agrarian Transformation and the Role of Iron", "points": [
                        "Early Vedic economy was predominantly pastoral; wealth was counted in cattle (Gomat, Gavishti). Agriculture was marginal.",
                        "In the Later Vedic period, the advent of iron ('Shyama Ayas' / 'Krishna Ayas') around 1000 BCE at Atranjikhera enabled deep clearing of dense Gangetic monsoon forests and the manufacture of iron ploughshares.",
                        "Resulted in agricultural surplus, transitioning from shifting pastoralism to sedentary settled village life ('Janapada')."
                    ]},
                    {"heading": "Polity: From Tribal Chiefdoms to Territorial Monarchies", "points": [
                        "Rajan evolved from a pastoral war-chief ('Gopati') without territorial claims into a territorial ruler ('Bhupapati').",
                        "Tribal popular assemblies (Sabha and Samiti), which included women in the Rigveda, lost power to royal lineage and nobility; Vidatha disappeared.",
                        "Introduction of grand legitimizing Vedic sacrifices: Rajasuya (consecration), Ashvamedha (imperial sovereignty), and Vajapeya (chariot race).",
                        "Emergence of embryonic tax collection: Voluntary 'Bali' transformed into compulsory tribute collected by 'Bhagadugha'."
                    ]},
                    {"heading": "Social Stratification and Varna Hierarchy", "points": [
                        "Rigvedic society possessed flexible occupational divisions with egalitarian elements (Purusha Sukta 10th Mandala being a late addition).",
                        "Later Vedic period witnessed the ossification of the fourfold Varna system (Brahmana, Kshatriya, Vaishya, Shudra) governed by strict ritual purity.",
                        "Degradation of the status of women: Loss of Upanayana rites, exclusion from assemblies, and emergence of child marriage and Gotra exogamy."
                    ]}
                ],
                "diagramMapIdea": "Comparative structural table: Early Vedic vs Later Vedic across Polity, Economy, Social Stratification, and Role of Women.",
                "conclusion": "The Later Vedic transformations, catalysed by iron metallurgy and agrarian surplus, laid the structural foundations for the emergence of Mahajanapadas and the Second Urbanization in the 6th century BCE."
            }
        },
        {
            "id": "mains_anc_004", "periodId": "age-of-mahajanapadas", "marks": 15, "wordLimit": 250, "isPyq": True,
            "yearSource": "UPSC CSE 2016 GS-1", "bookRef": "R.S. Sharma, Ch. 13; Upinder Singh, Ch. 6",
            "question": "The 6th century BCE in northern India witnessed an intense philosophical churning and the rise of heterodox movements. Analyse the socio-economic conditions that facilitated the emergence and popularity of Buddhism and Jainism.",
            "framework": {
                "intro": "The 6th century BCE represents a pivotal epoch in Indian history characterized by the 'Second Urbanization', the rise of territorial Mahajanapadas, and a profound intellectual revolt against Brahmanical sacrificial orthodoxy, crystallizing in the Shramana traditions of Gautama Buddha and Vardhamana Mahavira.",
                "body": [
                    {"heading": "Expansion of the Iron Economy and Need for Draught Cattle", "points": [
                        "The clearing of the middle Gangetic plains created intensive plough agriculture demanding heavy animal labour.",
                        "Vedic animal sacrifices (Pashubandha / Gomedha) depleted draught cattle, directly hurting peasant productivity.",
                        "Both Buddhism and Jainism preached Ahimsa (non-injury), directly protecting agrarian livestock assets."
                    ]},
                    {"heading": "Rise of the Mercantile Class (Vaishyas) and Coinage", "points": [
                        "The growth of craft guilds (Shrenis) and trade routes (Uttarapatha) produced a prosperous Vaishya class (Setthis, Gahapatis).",
                        "Brahmanical Dharmasutras condemned sea voyages and denounced money-lending (usury) as sinful.",
                        "Heterodox sects welcomed traders without social stigma, did not condemn usury, and accommodated wealth accumulation based on righteous conduct."
                    ]},
                    {"heading": "Reaction Against Varna Hegemony and Ritual Costs", "points": [
                        "Kshatriya rulers resented the ritual and social superiority claimed by the Brahmana priestly class.",
                        "Both Buddha and Mahavira hailed from Kshatriya aristocratic lineages (Gautama and Jnatrika clans) and challenged the divine origin of Varna based on birth.",
                        "Brahmana rituals were prohibitively expensive and conducted in obscure Sanskrit, whereas Shramana teachers preached in the vernacular (Pali and Ardhamagadhi), democratizing spiritual salvation."
                    ]},
                    {"heading": "Alienation Caused by Urban Life and Material Greed", "points": [
                        "Rapid urbanization, private property disputes, and state coercion in kingdoms generated social alienation and psychological distress.",
                        "The Buddhist Sangha and Jain monastic rules modeled after primitive tribal republics (Ganasanghas) provided a sanctuary of simplicity, communal equality, and detachment."
                    ]}
                ],
                "diagramMapIdea": "Concept map: Socio-Economic Pressures (Agrarian surplus, Cattle preservation, Mercantile wealth, Urban alienation) -> Religious Response (Ahimsa, Vernacular preaching, Sangha equality) -> Rise of Buddhism & Jainism.",
                "conclusion": "Buddhism and Jainism were thus not merely theological movements, but profound socio-economic responses to the material realities of the Second Urbanization, establishing ethical humanism at the core of Indian thought."
            }
        },
        {
            "id": "mains_anc_005", "periodId": "age-of-mahajanapadas", "marks": 10, "wordLimit": 150, "isPyq": False,
            "yearSource": "UPSC CSE Standard Practice", "bookRef": "Upinder Singh, Ch. 6; R.S. Sharma, Ch. 12",
            "question": "Differentiate between the monarchical kingdoms (Rajyas) and the non-monarchical republican states (Ganasanghas) of the 6th century BCE in ancient India.",
            "framework": {
                "intro": "The 6th century BCE witnessed two distinct forms of political organization among the sixteen Mahajanapadas: hereditary monarchies (e.g., Magadha, Kosala, Vatsa) and oligarchic clan republics known as Ganasanghas (e.g., Vrijji confederacy, Licchavis of Vaishali, Shakyas of Kapilavastu).",
                "body": [
                    {"heading": "Locus of Sovereign Power", "points": [
                        "Rajyas: Power was centralized in a single hereditary monarch whose authority was legitimized by divine ritual consecration (Brahmanical rites).",
                        "Ganasanghas: Sovereignty resided collectively in an assembly of clan oligarchs (Rajas). Decisions were taken through consensus, debate, and majority voting (Chhanda) in the Santhagara."
                    ]},
                    {"heading": "Social Structure and Role of Brahmanism", "points": [
                        "Rajyas: Strictly adhered to the orthodox fourfold Varna hierarchy, giving paramount privilege to Brahmanas and Kshatriyas.",
                        "Ganasanghas: Dominated by a single ruling Kshatriya clan; Brahmanas held minimal political clout. Society was bifurcated into ruling clan members and servile labourers (Dasa-kammakaras)."
                    ]},
                    {"heading": "Military and Fiscal Administration", "points": [
                        "Rajyas: Maintained a permanent standing army (Senabal) paid directly from regular imperial land taxation (Bhaga, Bali) collected by royal officers.",
                        "Ganasanghas: Relied on a militia of armed clan members led by clan chiefs; lacked a bureaucratic standing army, rendering them vulnerable to sustained monarchical siegecraft (as seen in Ajatashatru's 16-year campaign against Vaishali)."
                    ]}
                ],
                "diagramMapIdea": "Comparative matrix contrasting Rajyas (Monarchy, standing army, Varna orthodoxy) with Ganasanghas (Oligarchy, Santhagara voting, clan militia).",
                "conclusion": "Though the republican Ganasanghas eventually succumbed to the superior centralized resources of Magadha, they bequeathed invaluable democratic and consultative traditions that deeply influenced early Buddhist Sangha governance."
            }
        },
        {
            "id": "mains_anc_006", "periodId": "ashoka-the-great", "marks": 15, "wordLimit": 250, "isPyq": True,
            "yearSource": "UPSC CSE 2019 GS-1", "bookRef": "Romila Thapar, Ashoka; Upinder Singh, Ch. 7",
            "question": "Ashoka's policy of 'Dhamma' was neither a sectarian Buddhist doctrine nor a royal whim, but an astute political and moral ideology designed to preserve the unity of a vast, multi-ethnic empire. Critically evaluate.",
            "framework": {
                "intro": "Following the catastrophic carnage of the Kalinga War (c. 261 BCE), Emperor Ashoka propounded the policy of 'Dhamma' (Dharma). Historian Romila Thapar argues that Ashoka's Dhamma was a universal political philosophy tailored to integrate the heterogenous cultural, linguistic, and religious fault-lines of the sprawling Mauryan subcontinent.",
                "body": [
                    {"heading": "Universal Ethical Core vs Sectarian Dogma", "points": [
                        "Ashokan Dhamma did not emphasize specific Buddhist dogmatic tenets like the Four Noble Truths, the Eightfold Path, or Nirvana.",
                        "Instead, Major Rock Edicts emphasize universal ethical civic values: filial obedience (Sushrusa), kindness to slaves and servants (Dasa-Bhataka), non-injury to living beings (Ahimsa), and truthfulness.",
                        "Rock Edict XII specifically commands tolerance towards all religious sects (Samavaya - concourse of faiths) and forbids unprovoked slander of other religions."
                    ]},
                    {"heading": "Administrative Integration of a Heterogeneous Empire", "points": [
                        "The Mauryan empire stretched from Kandahar (Greek/Aramaic) to Karnataka (Prakrit) and Bengal, comprising tribal forest populations, agrarian plains, and urban merchants.",
                        "Dhamma served as a secular, overarching civic glue transcending regional dialects and theological dogmas, fostering imperial unity without coercive military suppression.",
                        "Created the cadre of 'Dhamma Mahamattas' (Major Rock Edict V) to inspect royal officials, redress grievances, propagate moral harmony, and supervise welfare among frontier tribes."
                    ]},
                    {"heading": "Foreign Policy: From Bherighosha to Dhammaghosha", "points": [
                        "Major Rock Edict XIII proclaims the abandonment of military aggression (Bherighosha) in favour of cultural and moral conquest (Dhammaghosha).",
                        "Dispatched peace embassies to contemporary Hellenistic kings: Antiochus II of Syria, Ptolemy II of Egypt, Antigonus of Macedonia, and Magas of Cyrene, transforming imperial foreign policy into cultural diplomacy."
                    ]},
                    {"heading": "Limitations and Historical Critiques", "points": [
                        "Scholars like Raychaudhuri argued that pacifism weakened the Mauryan martial apparatus, rendering frontiers vulnerable to Greco-Bactrian invasions.",
                        "However, Ashoka warned forest tribes that the Emperor possessed the power to punish if they transgressed (Major Rock Edict XIII), showing Dhamma was supported by sovereign state authority."
                    ]}
                ],
                "diagramMapIdea": "Flowchart linking Ashokan Dhamma components: Core Ethics (Ahimsa, Tolerance) + Administrative machinery (Dhamma Mahamattas) + Universal outreach (Prakrit/Greek edicts) = Multi-ethnic Subcontinental Imperial Unity.",
                "conclusion": "Ashoka's Dhamma represents an enduring civilizational breakthrough: the pioneering transformation of imperial statecraft from brute conquest into moral governance and pluralistic coexistence."
            }
        },
        {
            "id": "mains_anc_007", "periodId": "mauryan-empire", "marks": 15, "wordLimit": 250, "isPyq": False,
            "yearSource": "UPSC CSE Standard Practice", "bookRef": "Upinder Singh, Ch. 7; R.S. Sharma, Ch. 15",
            "question": "Compare the bureaucratic centralization and socio-political apparatus described in Kautilya's Arthashastra with the observations recorded in Megasthenes' Indica.",
            "framework": {
                "intro": "The Mauryan Empire (c. 322-185 BCE) is one of the best-documented periods in ancient India, with domestic political theory codified in Kautilya's 'Arthashastra' and external eyewitness observations preserved in Megasthenes' 'Indica'.",
                "body": [
                    {"heading": "Bureaucracy and State Control", "points": [
                        "Arthashastra: Depicts an intensely centralized administrative apparatus. Details 27 'Adhyakshas' (superintendents) regulating everything from agriculture (Sitadhyaksha), mining (Akaradhyaksha), to weights and measures (Pautavadhyaksha). Supported by an omnipresent espionage network (Gudhapurushas).",
                        "Indica: Megasthenes corroborates sophisticated administration by describing a 30-member municipal commission divided into 6 boards of five members each (industries, foreigners, births/deaths, trade, manufacturing, and tax collection) administering Pataliputra, and a similar 30-member board for the military."
                    ]},
                    {"heading": "Social Stratification and Caste Structure", "points": [
                        "Arthashastra: Adheres strictly to orthodox Brahmanical Varna classification (Brahmana, Kshatriya, Vaishya, Shudra) and prescribes legal penalties based on Varna rank.",
                    ...
                    {"heading": "Condition of Slavery and Exploitation", "points": [
                        "Arthashastra: Recognizes slavery ('Dasa') and specifies detailed legal codes ('Dasa-Kalpa') governing their treatment, rights, manumission, and prohibitions against enslaving free Aryas.",
                        "Indica: Megasthenes famously asserted that 'All Indians are free, and not even one of them is a slave.' He was likely misled because Indian domestic slavery was far less brutal than the dehumanizing Greco-Roman chattel slavery with which he was familiar."
                    ]},
                    {"heading": "Land Ownership and Agrarian Revenue", "points": [
                        "Arthashastra: Recognizes both crown lands managed directly by the state ('Sita') and private peasant holdings assessed for revenue ('Bhaga', typically 1/6th to 1/4th).",
                        "Indica: Megasthenes recorded that all land belonged exclusively to the King, and cultivators worked it for a payment of 1/4th produce, reflecting royal eminent domain."
                    ]}
                ],
                "diagramMapIdea": "Comparative synthesis table: Arthashastra vs Indica on Administration, Class/Varna, Slavery, and Land Rights.",
                "conclusion": "While Kautilya provides the theoretical normative blueprint of a powerful centralized state, Megasthenes offers an external empirical snapshot, together revealing the sophisticated governance of the Mauryan Empire."
            }
        },
        {
            "id": "mains_anc_008", "periodId": "post-mauryan-period", "marks": 15, "wordLimit": 250, "isPyq": True,
            "yearSource": "UPSC CSE 2017 GS-1", "bookRef": "Upinder Singh, Ch. 8; R.S. Sharma, Ch. 18",
            "question": "The Post-Mauryan era (c. 200 BCE - 300 CE) was marked by unprecedented integration with the global economy and flourishing internal craft guilds. Evaluate the economic and urban manifestations of this phase.",
            "framework": {
                "intro": "Often mischaracterized as a period of political fragmentation following the fall of the Mauryas, the Post-Mauryan epoch witnessed a vibrant economic boom, prolific urbanization, thriving craft guilds (Shrenis), and lucrative Indo-Roman maritime and overland trade across the Silk Road.",
                "body": [
                    {"heading": "Monetization and Proliferation of Coinage", "points": [
                        "Witnessed the highest level of currency monetization in ancient India.",
                        "Indo-Greeks introduced die-struck gold, silver, and copper coins bearing portraits and bilingual legends.",
                    ...
                    {"heading": "Autonomy and Sophistication of Craft Guilds (Shrenis)", "points": [
                        "Inscriptions at Nasik, Karle, and Junnar reveal guilds operating as autonomous commercial corporations with their own customary laws (Shreni-dharma).",
                        "Guilds acted as primitive commercial banks, accepting fixed interest-bearing deposits (Akshaya-nivi) from royalty and commoners to finance religious endowments and social works.",
                        "Specialized craft production: Ujjain (agate/carnelian beads), Mathura (sculpture and Shataka textiles), Madurai (pearls and muslin)."
                    ]},
                    {"heading": "Maritime Indo-Roman Trade and Balance of Payments", "points": [
                        "Described vividly in the anonymous 1st-century CE Greek navigational guide 'Periplus of the Erythraean Sea' and Pliny's 'Naturalis Historia'.",
                        "Indian ports: Barygaza (Bharuch), Muziris (Kodungallur), Sopara, and Arikamedu (Poduke).",
                        "Exports: Black pepper ('Yavanapriya'), fine muslin, malabathrum, ivory, pearls, and wild animals.",
                        "Imports: Roman gold and silver denarii, amphorae containing wine, and Italian Arretine pottery.",
                        "Roman senator Pliny famously lamented that Rome was drained of over 100 million sesterces annually to satisfy luxury Indian imports."
                    ]},
                    {"heading": "Urban Growth and Thriving Trading Hubs", "points": [
                        "Archaeological excavations demonstrate the zenith of urban habitation (Mathura, Taxila, Ujjain, Paithan, Kaveripattinam, Shishupalgarh) with multi-storeyed burnt-brick buildings, terracotta ring-wells, and soak pits."
                    ]}
                ],
                "diagramMapIdea": "Trade map sketch showing ports (Barygaza, Muziris, Arikamedu), overland Uttarapatha and Dakshinapatha routes, and the monsoon navigation corridor across the Arabian Sea.",
                "conclusion": "The Post-Mauryan economic vitality demonstrated that political decentralization is fully compatible with commercial expansion, cultural cosmopolitanism, and high artistic achievement."
            }
        },
        {
            "id": "mains_anc_009", "periodId": "gupta-empire", "marks": 15, "wordLimit": 250, "isPyq": True,
            "yearSource": "UPSC CSE 2021 GS-1", "bookRef": "R.S. Sharma, Ch. 20; Upinder Singh, Ch. 9",
            "question": "The Gupta period has traditionally been hailed as the 'Golden Age' of ancient India. In the light of recent historiography, assess the validity of this characterization.",
            "framework": {
                "intro": "Colonial and nationalist historians christened the Gupta period (c. 319-550 CE) as the 'Golden Age' or 'Classical Age' of India, pointing to classical Sanskrit literature, artistic achievements, and scientific breakthroughs. Modern critical historiography (e.g., R.S. Sharma, D.N. Jha), however, reveals profound socio-economic contradictions beneath this cultural elite facade.",
                "body": [
                    {"heading": "Arguments Supporting the 'Golden Age' Paradigm", "points": [
                        "Literary Zenith: Flourishing of classical Sanskrit drama and poetry under Kalidasa (Abhijnanashakuntalam, Meghadutam), Vishakhadatta, and Sudraka.",
                        "Scientific Breakthroughs: Aryabhata's 'Aryabhatiya' (heliocentric hints, calculation of pi, zero/decimal notation, cause of solar/lunar eclipses) and Varahamihira's 'Brihatsamhita' and 'Panchasiddhantika'.",
                        "Metallurgical and Artistic Mastery: The rustless Iron Pillar of Mehrauli; rock-cut cave paintings at Ajanta (Caves 16, 17, 19); sublime Sarnath seated Buddha sculpture reflecting spiritual inwardness.",
                        "Numismatic Splendour: High artistic purity of Gupta gold coins (Dinaras) depicting monarchs playing veena, performing Ashvamedha, and hunting."
                    ]},
                    {"heading": "Contradictions and the Dark Underbelly: Revisionist Historiography", "points": [
                        "Emergence of Feudalism and Subinfeudation: Widespread royal land grants (Agraharas and Brahmadeyas) transferred judicial and administrative rights to priestly donees, weakening central authority and subjecting peasants to forced unpaid labour ('Vishti').",
                        "Decline of Urban Centres and Trade: Excavations show decay in urban centres (Hastinapur, Kaushambi, Shravasti) and cessation of Indo-Roman maritime commerce; minting of poor-quality copper coins reflected reduced monetization for the common populace.",
                        "Social Degradation of Lower Castes: Rigidification of the Varna-Jati framework. Chinese traveller Faxian documented that Chandalas (untouchables) had to strike a wooden clapper when entering city gates to alert caste-Hindus to avoid pollution.",
                ...
                "diagramMapIdea": "Balance scale diagram: Elite Cultural Zenith (Sanskrit, Aryabhata, Ajanta, Gold coins) vs Subaltern Social Realities (Vishti forced labour, Urban decay, Untouchability, Eran Sati).",
                "conclusion": "The Gupta era was undeniably a 'Golden Age' for courtly literature, science, and the artistic elite, but for women, peasants, and the lower Varnas, it marked an era of creeping feudal subjugation and social rigidity."
            }
        },
        {
            "id": "mains_anc_010", "periodId": "harsha-and-his-times", "marks": 10, "wordLimit": 150, "isPyq": False,
            "yearSource": "UPSC CSE Standard Practice", "bookRef": "Upinder Singh, Ch. 9; R.S. Sharma, Ch. 21",
            "question": "Harshavardhana's reign (606-647 CE) reflects both the sunset of classical imperial unity and the dawn of early medieval feudal decentralization. Elucidate.",
            "framework": {
                "intro": "Harshavardhana of Pushyabhuti dynasty united northern India following the Hun invasions, ruling from Kannauj. His reign constitutes a watershed transition from the classical pan-Indian empire to regionalized early medieval feudal polities.",
                "body": [
                    {"heading": "Sunset of Imperial Authority", "points": [
                        "Harsha revived imperial grandeur through extensive military campaigns across northern India ('Sakalottarapathanatha').",
                        "Patronized literature (composed Ratnavali, Priyadarsika, Nagananda) and convened magnificent grand assemblies at Kannauj and the quinquennial Prayaga assembly observed by Xuanzang.",
                        "Patronized Nalanda Mahavihara, funding it through revenue grants from over 100 villages."
                    ]},
                    {"heading": "Dawn of Feudalization and Decentralization", "points": [
                        "Inability to forge a permanent all-India empire: Decisively defeated on the Narmada banks by Chalukya monarch Pulakeshin II (recorded in Ravikirti's Aihole Prashasti).",
                        "State officials were no longer paid in cash salaries but in assignments of land revenues and villages, accelerating the growth of autonomous 'Samantas' (feudatories).",
                        "Xuanzang observed that law and order was far more precarious than under the Guptas; he was robbed multiple times on imperial highways.",
                        "The empire disintegrated immediately upon Harsha's death (647 CE), giving way to the fragmented Tripartite Struggle."
                    ]}
                ],
                "diagramMapIdea": "Timeline / Conceptual bridge diagram: Centralized Imperial Guptas -> Harsha (Hybrid Transition) -> Early Medieval Feudal Polities (Tripartite Struggle).",
                "conclusion": "Harsha stood as the last great emperor of classical North India; his reliance on feudatory Samantas prefigured the decentralized political landscape of the medieval era."
            }
        },
        {
            "id": "mains_anc_011", "periodId": "sangam-age", "marks": 15, "wordLimit": 250, "isPyq": True,
            "yearSource": "UPSC CSE 2015 GS-1", "bookRef": "Upinder Singh, Ch. 8; Nitin Singhania",
            "question": "Sangam literature provides an authentic window into the socio-economic life, ecological diversity, and political contours of early South India. Discuss with reference to the concept of 'Thinai'.",
            "framework": {
                "intro": "The Sangam corpus (c. 300 BCE - 300 CE), compiled across three literary academies under Pandyan patronage, represents the earliest secular poetic literature of South India, categorized into Akam (internal, love poetry) and Puram (external, heroism and polity).",
                "body": [
                    {"heading": "The Five Eco-zones ('Ainthinai') and Economic Adaptation", "points": [
                        "The unique concept of 'Thinai' reflects acute ecological consciousness where geographical landscape determined economic subsistence and social habits:",
                        "1. Kurinji (Hilly/Forest): Hunting and honey collection; deity Murugan.",
                        "2. Mullai (Pastoral Scrubland): Animal husbandry and shifting millets; deity Mayon (Krishna).",
                        "3. Marudam (Fertile River Plains): Intensive wet-rice agriculture, tank irrigation; deity Ventan (Indra). Highest social stratification.",
                        "4. Neydal (Coastal/Littoral): Fishing and salt manufacturing (Umanar traders); deity Varunan.",
                        "5. Palai (Parched Arid Wasteland): Highway raiding and banditry; deity Korravai (goddess of war)."
                    ]},
                    {"heading": "Polity: The Muvendar and Heroic Chieftaincies", "points": [
                        "Identifies the three crowned monarchs ('Muvendar'): Cheras (Vanji), Cholas (Uraiyur/Puhar), and Pandyas (Madurai), alongside independent chieftains (Velirs).",
                        "Warfare was endemic, primarily driven by cattle-raids ('Vetchi'). Fallen warriors were consecrated with inscribed Hero Stones ('Nadukal' / 'Virakkal').",
                        "Rulers maintained legitimacy by lavishly redistributing captured booty and gifts to bards (Panar) and poets."
                    ]},
                    {"heading": "Lively Commercial Life and Urban Trading Centres", "points": [
                        "Puhar (Kaveripattinam) is vividly described in 'Silappadikaram' with bustling foreign merchants (Yavanas), harbour docks, and warehouses.",
                    ...
                    {"heading": "Social Structure: Non-Vedic Roots", "points": [
                        "Absence of rigid North Indian fourfold Varna hierarchy. Status was determined by clan kinship, ecology, and occupation (e.g., Enadi for military chiefs, Vellalas for land-owning farmers, Paraiyar for agricultural labourers).",
                        "Women enjoyed literary freedom; over 30 female poets (notably Avvaiyar, Velli Vithiyar) contributed to the Sangam anthologies."
                    ]}
                ],
                "diagramMapIdea": "Five-column schematic showing the 5 Thinais: Landscape, Subsistence, Deity, and Literary Mood.",
                "conclusion": "Sangam literature stands as a timeless masterpiece of ecological determinism and cultural realism, capturing the vibrant dawn of peninsular Indian civilization."
            }
        },
        {
            "id": "mains_anc_012", "periodId": "kingdoms-of-south", "marks": 15, "wordLimit": 250, "isPyq": False,
            "yearSource": "UPSC CSE Standard Practice", "bookRef": "Upinder Singh, Ch. 10; Nitin Singhania, Ch. 1",
            "question": "Analyse the architectural evolution from rock-cut cave shrines to monolithic rathas and structural stone temples under the Pallavas of Kanchi.",
            "framework": {
                "intro": "The Pallavas of Kanchipuram (c. 6th - 9th centuries CE) laid the foundational architectural vocabulary of South Indian Dravidian temple architecture, progressing sequentially through four distinct evolutionary phases.",
                "body": [
                    {"heading": "1. Mahendra Style (600-630 CE) - Rock-Cut Excavation", "points": [
                        "Initiated by king Mahendravarman I, proud bearer of the title 'Vichitrachitta' (curious-minded).",
                        "Directly excavated pillared cave temples ('Mandapas') out of living granite bedrock without using brick, mortar, or timber (e.g., Mandagapattu inscription: temple to Brahma, Shiva, and Vishnu).",
                        "Features: Plain massive octagonal pillars with square blocks, simple corbels, and guardian dvarapalas flanking sanctums (e.g., Trichy, Bhairavakonda)."
                    ]},
                    {"heading": "2. Mamalla Style (630-668 CE) - Monolithic Rathas and Open-Air Bas-Reliefs", "points": [
                        "Developed by Narasimhavarman I (Mamalla) at the port city of Mamallapuram (Mahabalipuram).",
                        "Monolithic Free-Standing Sculptured Temples ('Rathas' or Seven Pagodas): Carved top-down from single granite boulders (Dharmaraja, Bhima, Arjuna, Draupadi, Nakula-Sahadeva).",
                        "Features: Slender fluted pillars resting on seated lion bases; embryonic Dravidian tiered Shikharas.",
                        "Grand Open-Air Rock Relief: 'Descent of the Ganga' (or Arjuna's Penance) carved on two massive boulders, celebrating naturalistic animal sculpting (cleft as Ganga with Nagas, elephants, ascetics)."
                    ]},
                    {"heading": "3. Rajasimha Style (700-728 CE) - Advent of Free-Standing Structural Stone Masonry", "points": [
                        "Pioneered by Narasimhavarman II (Rajasimha).",
                        "Shifted definitively from cave excavation to assembling structural stone blocks of granite and sandstone.",
                        "Masterpieces: Shore Temple at Mahabalipuram (facing the Bay of Bengal with tiered vimana) and the Kailasanatha Temple at Kanchipuram.",
                        "Features: Enclosure walls (Prakara), early Gopurams, pyramidal stepped vimanas, and rampart lion pilasters."
                    ]},
                    {"heading": "4. Nandivarman Style (728-900 CE) - Declining Scale and Ornamentation", "points": [
                        "Represented by later Pallavas (Nandivarman II, Aparajita). Small, compact structural temples (e.g., Vaikuntha Perumal at Kanchipuram, Mukteshwara temple).",
                        "Paved the way for the imperial monumentalism of the Cholas."
                    ]}
                ],
                "diagramMapIdea": "Evolutionary timeline flowchart: Mahendra style (Rock-cut Caves) -> Mamalla style (Monolithic Rathas) -> Rajasimha style (Structural Shore/Kailasanatha) -> Imperial Chola Vimanas.",
                "conclusion": "The Pallavas decisively transformed Indian rock into living architectural hymns, establishing the structural DNA that culminated in the colossal temples of Thanjavur and Hampi."
            }
        },
        {
            "id": "mains_anc_013", "periodId": "ancient-religion", "marks": 10, "wordLimit": 150, "isPyq": False,
            "yearSource": "UPSC CSE Standard Practice", "bookRef": "Upinder Singh, Ch. 6; NCERT Class 12 Themes Theme 2",
            "question": "Differentiate between the philosophical tenets and monastic codes of early Buddhism (Theravada/Hinayana) and Jainism (Digambara/Svetambara).",
            "framework": {
                "intro": "Originating in the 6th century BCE Shramana ferment, Buddhism and Jainism rejected Vedic sacrificial ritualism and Varna supremacy, yet diverged fundamentally in their metaphysical doctrines and ascetic rigor.",
                "body": [
                    {"heading": "Concept of Soul and Material Reality", "points": [
                        "Jainism: Extreme pan-psychic animism. Believes in eternal souls ('Jiva') possessing consciousness present not just in humans and animals, but also in plants, water, fire, and rocks. Matter ('Ajiva') binds the soul through karmic inflow ('Asrava').",
                    ...
                    {"heading": "Ascetic Practice: Extreme Mortification vs Middle Path", "points": [
                        "Jainism: Espouses rigorous self-mortification, extreme penance, and bodily denial to purge accumulated karmic dust ('Nirjara'). Climaxed in Sallekhana (peaceful fasting unto death). Digambara monks renounce even clothing.",
                        "Buddhism: Rejects both hedonistic indulgence and brutal self-torture, championing the 'Majjhima Patipada' (Middle Path) and the Eightfold Path (Ashtangika Marga)."
                    ]},
                    {"heading": "Ahimsa (Non-Violence)", "points": [
                        "Jainism: Absolute, uncompromising Ahimsa. Monks wear mouth-cloths (Muhapatti) and sweep paths with feather whisks to avoid injuring microbes; forbidden from farming due to injury to earthworms.",
                        "Buddhism: Practical and pragmatic Ahimsa; emphasizes compassionate intention (Karuna/Metta). Lay followers and monks were allowed to consume meat if not slaughtered specifically for them."
                    ]}
                ],
                "diagramMapIdea": "Side-by-side comparative table: Metaphysics (Jiva vs Anatta), Ascetic path (Severe Tapas vs Middle Path), Epistemology (Syadvada vs Pratityasamutpada).",
                "conclusion": "While Jainism's absolute asceticism kept it largely concentrated within India's mercantile heartland, Buddhism's pragmatic Middle Path facilitated its rapid pan-Asian transcontinental expansion."
            }
        },
        {
            "id": "mains_anc_014", "periodId": "ancient-science", "marks": 10, "wordLimit": 150, "isPyq": True,
            "yearSource": "UPSC CSE 2014 GS-1", "bookRef": "A.L. Basham, The Wonder That Was India; NCERT",
            "question": "Highlight the pioneering contributions of ancient India in the fields of mathematics, astronomy, and medicine.",
            "framework": {
                "intro": "Ancient Indian scientific enquiry was empirical, rational, and deeply integrated into daily astronomical, architectural, and medicinal needs, generating foundational concepts that influenced global civilization via Arab transmissions.",
                "body": [
                    {"heading": "Mathematics: The Zero and Decimal System", "points": [
                        "Invention of the symbol Zero ('Shunya') and the base-10 positional place-value decimal system, described by Laplace as an invention of profound genius.",
                        "Aryabhata (5th c. CE): Calculated the value of Pi to 3.1416, solved indeterminate equations, and formulated rules for calculating areas of triangles and volumes of spheres.",
                        "Brahmagupta (7th c. CE): In 'Brahmasphutasiddhanta', codified mathematical arithmetic operations involving zero and negative numbers."
                    ]},
                    {"heading": "Astronomy: Celestial Mechanics", "points": [
                        "Aryabhata posited that the Earth is spherical and rotates on its own axis daily, correctly explaining that solar and lunar eclipses are caused by planetary shadows rather than Rahu/Ketu demons.",
                        "Varahamihira (6th c. CE): Authored 'Panchasiddhantika' and 'Brihatsamhita', synthesizing indigenous knowledge with Greco-Roman (Romaka and Paulisa) astronomical principles."
                    ]},
                    {"heading": "Medicine: Ayurveda and Surgery", "points": [
                        "Charaka Samhita (Charaka): Foundational compendium on internal medicine, pathology, and therapeutics based on the equilibrium of the three humours ('Tridosha': Vata, Pitta, Kapha).",
                        "Sushruta Samhita (Sushruta - Father of Surgery): Detailed over 300 surgical procedures, including rhinoplasty (plastic surgery), cataract removal, lithotomy, and documented 121 surgical instruments."
                    ]}
                ],
                "diagramMapIdea": "Triangular flowchart: Math (Zero, Decimal, Pi) + Astronomy (Earth's rotation, Eclipses) + Medicine (Charaka, Sushruta's surgery) -> Global transmission via Arab scholars (Al-Khwarizmi).",
                "conclusion": "These breakthroughs underline that ancient Indian intellect was as profoundly invested in rational secular sciences as it was in metaphysical philosophy."
            }
        },
        {
            "id": "mains_anc_015", "periodId": "prehistoric-india", "marks": 10, "wordLimit": 150, "isPyq": False,
            "yearSource": "UPSC CSE Standard Practice", "bookRef": "Upinder Singh, Ch. 3; NCERT Class 11 An Introduction to Indian Art",
            "question": "Rock art of Bhimbetka offers an authentic visual narrative of the daily life, ecological consciousness, and cognitive evolution of prehistoric humans. Elucidate.",
            "framework": {
                "intro": "The rock shelters of Bhimbetka (Madhya Pradesh, discovered by V.S. Wakankar in 1957), a UNESCO World Heritage site, preserve continuous artistic strata spanning the Upper Palaeolithic, Mesolithic, and Chalcolithic periods.",
                "body": [
                    {"heading": "Visual Archive of Daily Subsistence and Economy", "points": [
                        "Mesolithic paintings (the most numerous) depict collective hunting scenes: hunters armed with barbed spears, bows, arrows, and sticks chasing wild beasts.",
                        "Women are depicted gathering wild roots, honeycombing, carrying children in skin baskets, and preparing food, revealing egalitarian gender division of labour.",
                        "Depiction of domestic pastoralism and riding horses/elephants in later Chalcolithic layers."
                    ]},
                    {"heading": "Cognitive and Socio-Cultural Evolution", "points": [
                        "Depiction of communal group dances in synchronized lines holding hands accompanied by drums, marking the birth of ritual celebration and proto-social cohesion.",
                        "Masked human figures, 'horned sorcerers', and funeral rituals indicate emerging spiritual consciousness and shamanistic animism."
                    ]},
                    {"heading": "Artistic Technique and Ecological Palette", "points": [
                        "Natural mineral pigments: Haematite/ochre (Geru) for red, limestone/gypsum for white, copper ore for green, bound using animal fat and tree resins.",
                        "Dynamic stick-like kinetic figures capturing movement with acute anatomical observation of 29 animal species (bison, boars, tigers, rhinos)."
                    ]}
                ],
                "diagramMapIdea": "Sketch diagram representing Mesolithic stick-figure community dancing line and dynamic hunter with bow and arrow.",
                "conclusion": "Bhimbetka's rock art serves not merely as primitive aesthetic expression, but as humanity's earliest visual encyclopedia of survival, social bonding, and artistic impulse."
            }
        }
    ]

    # Additional 25 Ancient Mains questions to make exactly 40
    # Let's generate items 16 to 40
    anc_25 = [
        ("mains_anc_016", "prehistoric-india", 10, 150, False, "Standard Practice", "NCERT Class 11; Upinder Singh",
        ...
        ("mains_anc_017", "ashoka-the-great", 10, 150, True, "UPSC CSE 2022 GS-1", "Nitin Singhania, Ch. 1",
        ...
        ("mains_anc_018", "post-mauryan-period", 15, 250, False, "Standard Practice", "Upinder Singh, Ch. 8",
        ...
        ("mains_anc_019", "gupta-empire", 15, 250, True, "UPSC CSE 2021 GS-1", "R.S. Sharma, Ch. 20",
        ...
        ("mains_anc_020", "ancient-religion", 15, 250, True, "UPSC CSE 2013 GS-1", "Nitin Singhania, Ch. 1; NCERT Class 11",
        ...
        ("mains_anc_021", "post-mauryan-period", 15, 250, True, "UPSC CSE 2014 GS-1", "Nitin Singhania, Ch. 1; Upinder Singh, Ch. 8",
        ...
        ("mains_anc_022", "ancient-art", 15, 250, True, "UPSC CSE 2019 GS-1", "Nitin Singhania, Ch. 2; NCERT Class 11",
        ...
        ("mains_anc_023", "mauryan-empire", 10, 150, False, "Standard Practice", "Upinder Singh, Ch. 7",
        ...
        ("mains_anc_024", "prehistoric-india", 10, 150, False, "Standard Practice", "Upinder Singh, Ch. 3",
        ...
        ("mains_anc_025", "indus-valley-civilization", 10, 150, False, "Standard Practice", "Upinder Singh, Ch. 4",
        ...
        ("mains_anc_026", "vedic-age", 10, 150, False, "Standard Practice", "R.S. Sharma, Ch. 11",
        ...
        ("mains_anc_027", "vedic-age", 10, 150, False, "Standard Practice", "NCERT Class 12 Themes Theme 2",
        ...
        ("mains_anc_028", "age-of-mahajanapadas", 15, 250, False, "Standard Practice", "R.S. Sharma, Ch. 12",
        ...
        ("mains_anc_029", "age-of-mahajanapadas", 10, 150, False, "Standard Practice", "Upinder Singh, Ch. 6",
        ...
        ("mains_anc_030", "ashoka-the-great", 15, 250, False, "Standard Practice", "Romila Thapar; NCERT Themes Theme 2",
        ...
        ("mains_anc_031", "mauryan-empire", 10, 150, False, "Standard Practice", "R.S. Sharma, Ch. 15",
        ...
        ("mains_anc_032", "post-mauryan-period", 10, 150, False, "Standard Practice", "Upinder Singh, Ch. 8",
        ...
        ("mains_anc_033", "post-mauryan-period", 10, 150, False, "Standard Practice", "Upinder Singh, Ch. 8",
        ...
        ("mains_anc_034", "post-mauryan-period", 10, 150, False, "Standard Practice", "Upinder Singh, Ch. 8",
        ...
        ("mains_anc_035", "gupta-empire", 15, 250, False, "Standard Practice", "R.S. Sharma, Ch. 20; Upinder Singh, Ch. 9",
        ...
        ("mains_anc_036", "gupta-empire", 10, 150, False, "Standard Practice", "Upinder Singh, Ch. 9",
        ...
        ("mains_anc_037", "early-medieval-period", 15, 250, True, "UPSC CSE 2016 GS-1", "R.S. Sharma, Indian Feudalism; B.D. Chattopadhyaya",
        ...
        ("mains_anc_038", "imperial-cholas", 15, 250, True, "UPSC CSE 2018 GS-1", "Satish Chandra, Ch. 2; Upinder Singh, Ch. 10",
         ...
         "Flowchart of Chola Sabha governance: Kudavolai drawing -> Selection to 5 Variyams -> Supervised by Royal officers.",
        ...
        ("mains_anc_039", "early-medieval-period", 10, 150, False, "Standard Practice", "Satish Chandra, Ch. 1",
        ...
        ("mains_anc_040", "ancient-religion", 10, 150, False, "Standard Practice", "R.S. Sharma, Ch. 22; Upinder Singh",
...
if __name__ == '__main__':
    ...
    print(f"Generated {len(anc)} Ancient Mains questions ({anc[0]['id']} to {anc[-1]['id']})")
    with open('data/batch_mains_ancient.json', 'w', encoding='utf8') as f:
